...
/* BOOLEAN:OBJECT (gnm-marshalers.list:23) */
void
...
/* BOOLEAN:POINTER (gnm-marshalers.list:24) */
void
...
/* INT:INT (gnm-marshalers.list:25) */
void
...
/* POINTER:INT,INT (gnm-marshalers.list:26) */
void
...
/* POINTER:VOID (gnm-marshalers.list:27) */
void
...
/* VOID:INT,INT (gnm-marshalers.list:28) */
void
